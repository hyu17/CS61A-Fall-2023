...
def boar_brawl(player_score, opponent_score):
    ...
    return max(3 * abs(player_score_ones_digit - opponent_score_tens_digit), 1)
    # END PROBLEM 2
...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    If num_rolls is zero, use BOAR BRAWL strategy, otherwise use ROLL DICE strategy.
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            dice_nums0 = strategy0(score0, score1)
            score0 = update(dice_nums0, score0, score1, dice)
        else:
            dice_nums1 = strategy1(score1, score0)
            score1 = update(dice_nums1, score1, score0, dice)
        who = 1 - who
    # END PROBLEM 5
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    rolls_num = 1 
    max_rolls_num, max_averaged_score = 1, 0
    while rolls_num <= 10:
        averaged_dice = make_averaged(roll_dice, samples_count)
        current_score = averaged_dice(rolls_num, dice)
        if max_averaged_score < current_score:
            max_rolls_num = rolls_num
            max_averaged_score = current_score
        rolls_num += 1
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    curr_score = boar_brawl(score, opponent_score)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    score_updated = sus_update(0, score, opponent_score)
    if score_updated - score >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
